...
// https://github.com/sispop-project/sispop-improvement-proposals/issues/24 for more details.  This ends
// after 6 months.
...
constexpr uint64_t BLOCK_REWARD_HF17      = 2000'000'000'000;
constexpr uint64_t FOUNDATION_REWARD_HF17 =  350'000'000'000;
...
constexpr uint64_t burn_needed(uint8_t hf_version, mapping_type type)
{
  ...
  const uint64_t basic_fee = (
      ...
      2000*COIN                       // cryptonote::network_version_15_ons
  );
  switch (type)
  {
