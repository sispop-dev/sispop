...
# Make the RPC request to some sispopd
...
# For sispopnet addresses and HF16+ session addresses we'll always have an encrypted value and an
...
# val will currently be the raw sispopnet ed25519 pubkey (32 bytes).  We can convert it to the more
# common sispopnet address (which is the same value but encoded in z-base-32) and convert the bytes to
# a string:
