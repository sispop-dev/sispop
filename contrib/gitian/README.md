...
```bash
git clone git@github.com:sispopplatform/gitian.sigs.git
...
[sispopplatform/gitian.sigs](https://github.com/sispopplatform/gitian.sigs/) repository:
...
```bash
./gitian-build.py --detach-sign --no-commit --url https://github.com/sispopplatform/sispop -b <branch> <commit hash>
```
